defmodule AmazingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AmazingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AmazingWeb.Gettext, "errors", msg, opts)
    end
  end
